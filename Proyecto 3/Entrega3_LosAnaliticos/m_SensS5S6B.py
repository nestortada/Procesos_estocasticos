...
def Starting_State():  
    ...
    s5 = 10 # Es la contidad incial que comienza en el primer dia con la primera divisa
    s6 = 10 # Es la cantidad incial que comienza en el primer día con la primera divisa
    s = (s1,s2,s3,s4,s5,s6)
    return s
